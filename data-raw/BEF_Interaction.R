...
f_indirect <- function(x) .1*pweibull(x,shape=4,scale=.1,lower.tail=F)
...
y <- 25 + sex*-2  + centered_income*-2  + FFRexposure + FFR_sq_exposure + rnorm(num_subj,sd=1.5)
