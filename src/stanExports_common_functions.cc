...
#include "stanExports_common_functions.h"

RCPP_MODULE(stan_fit4common_functions_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_common_functions")
