...
#include "stanExports_rvc_continuous.h"

RCPP_MODULE(stan_fit4rvc_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_rvc_continuous")
