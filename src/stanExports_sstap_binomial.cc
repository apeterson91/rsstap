...
#include "stanExports_sstap_binomial.h"

RCPP_MODULE(stan_fit4sstap_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sstap_binomial")
