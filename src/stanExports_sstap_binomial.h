...
namespace model_sstap_binomial_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sstap_binomial");
    reader.add_event(2, 2, "include", "functions/common_functions.stan");
    reader.add_event(2, 0, "start", "functions/common_functions.stan");
    reader.add_event(205, 203, "end", "functions/common_functions.stan");
    reader.add_event(205, 3, "restart", "model_sstap_binomial");
    reader.add_event(242, 40, "include", "data/weights.stan");
    reader.add_event(242, 0, "start", "data/weights.stan");
    reader.add_event(244, 2, "end", "data/weights.stan");
    reader.add_event(244, 41, "restart", "model_sstap_binomial");
    reader.add_event(245, 42, "include", "data/glmer_stuff.stan");
    reader.add_event(245, 0, "start", "data/glmer_stuff.stan");
    reader.add_event(260, 15, "end", "data/glmer_stuff.stan");
    reader.add_event(260, 43, "restart", "model_sstap_binomial");
    reader.add_event(260, 43, "include", "data/glmer_stuff2.stan");
    reader.add_event(260, 0, "start", "data/glmer_stuff2.stan");
    reader.add_event(265, 5, "end", "data/glmer_stuff2.stan");
    reader.add_event(265, 44, "restart", "model_sstap_binomial");
    reader.add_event(268, 47, "include", "tdata/tdata_glmer.stan");
    reader.add_event(268, 0, "start", "tdata/tdata_glmer.stan");
    reader.add_event(283, 15, "end", "tdata/tdata_glmer.stan");
    reader.add_event(283, 48, "restart", "model_sstap_binomial");
    reader.add_event(287, 52, "include", "parameters/parameters_glmer.stan");
    reader.add_event(287, 0, "start", "parameters/parameters_glmer.stan");
    reader.add_event(292, 5, "end", "parameters/parameters_glmer.stan");
    reader.add_event(292, 53, "restart", "model_sstap_binomial");
    reader.add_event(300, 61, "include", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(300, 0, "start", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(322, 22, "end", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(322, 62, "restart", "model_sstap_binomial");
    reader.add_event(358, 96, "end", "model_sstap_binomial");
    return reader;
}
...
class model_sstap_binomial
  : public stan::model::model_base_crtp<model_sstap_binomial> {
private:
        int N;
        std::vector<int> num_trials;
        std::vector<int> y;
        int ncol_Z;
        int ncol_smooth;
        int K_smooth;
...
public:
    model_sstap_binomial(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sstap_binomial_namespace::model_sstap_binomial";
        ...
        try {
            ...
            validate_non_negative_index("num_trials", "N", N);
            context__.validate_dims("data initialization", "num_trials", "int", context__.to_vec(N));
            num_trials = std::vector<int>(N, int(0));
            vals_i__ = context__.vals_i("num_trials");
            pos__ = 0;
            size_t num_trials_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < num_trials_k_0_max__; ++k_0__) {
                num_trials[k_0__] = vals_i__[pos__++];
            }
            size_t num_trials_i_0_max__ = N;
            for (size_t i_0__ = 0; i_0__ < num_trials_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "num_trials[i_0__]", num_trials[i_0__], 1);
            }
        ...
        try {
            ...
            if (as_bool(logical_gt(t, 0))) {
                ...
                if (as_bool(logical_eq(special_case, 1))) {
                    ...
                    stan::math::assign(theta_L, elt_multiply(scale, tau_b));
                    ...
                    stan::math::assign(theta_L, make_theta_L(len_theta_L, p, 1, tau_b, scale, zeta, rho, z_T, pstream__));
            ...
            if (as_bool(has_weights)) {
                ...
                lp_accum__.add(dot_product(weights, pw_binom(y, num_trials, eta, 1, pstream__)));
            } else {
                current_statement_begin__ = 334;
                lp_accum__.add(binomial_logit_log<propto__>(y, num_trials, eta));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sstap_binomial_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_sstap_binomial_namespace::model_sstap_binomial stan_model;
#ifndef USING_R
