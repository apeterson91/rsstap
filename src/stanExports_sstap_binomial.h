...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(225, 23, "include", "data/glmer_stuff.stan");
    reader.add_event(225, 0, "start", "data/glmer_stuff.stan");
    reader.add_event(240, 15, "end", "data/glmer_stuff.stan");
    reader.add_event(240, 24, "restart", "model_sstap_binomial");
    reader.add_event(240, 24, "include", "data/glmer_stuff2.stan");
    reader.add_event(240, 0, "start", "data/glmer_stuff2.stan");
    reader.add_event(245, 5, "end", "data/glmer_stuff2.stan");
    reader.add_event(245, 25, "restart", "model_sstap_binomial");
    reader.add_event(248, 28, "include", "tdata/tdata_glmer.stan");
    reader.add_event(248, 0, "start", "tdata/tdata_glmer.stan");
    reader.add_event(263, 15, "end", "tdata/tdata_glmer.stan");
    reader.add_event(263, 29, "restart", "model_sstap_binomial");
    reader.add_event(267, 33, "include", "parameters/parameters_glmer.stan");
    reader.add_event(267, 0, "start", "parameters/parameters_glmer.stan");
    reader.add_event(272, 5, "end", "parameters/parameters_glmer.stan");
    reader.add_event(272, 34, "restart", "model_sstap_binomial");
    reader.add_event(280, 42, "include", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(280, 0, "start", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(302, 22, "end", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(302, 43, "restart", "model_sstap_binomial");
    reader.add_event(337, 76, "end", "model_sstap_binomial");
    return reader;
}
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            stan::math::assign(yhat, binomial_rng(num_trials, elt_divide(stan::math::exp(eta), add(1, stan::math::exp(eta))), base_rng__));
