...
#include "stanExports_sstap_continuous.h"

RCPP_MODULE(stan_fit4sstap_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sstap_continuous")
