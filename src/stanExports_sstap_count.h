...
namespace model_sstap_count_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sstap_count");
    ...
    reader.add_event(205, 3, "restart", "model_sstap_count");
    ...
    reader.add_event(244, 41, "restart", "model_sstap_count");
    ...
    reader.add_event(260, 43, "restart", "model_sstap_count");
    ...
    reader.add_event(265, 44, "restart", "model_sstap_count");
    ...
    reader.add_event(283, 48, "restart", "model_sstap_count");
    ...
    reader.add_event(292, 53, "restart", "model_sstap_count");
    reader.add_event(299, 60, "include", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(299, 0, "start", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(321, 22, "end", "tparameters/tparameters_glmer_noaux.stan");
    reader.add_event(321, 61, "restart", "model_sstap_count");
    reader.add_event(354, 92, "end", "model_sstap_count");
    return reader;
}
...
class model_sstap_count
  : public stan::model::model_base_crtp<model_sstap_count> {
private:
        int N;
        std::vector<int> y;
        int ncol_Z;
...
public:
    model_sstap_count(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sstap_count_namespace::model_sstap_count";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(eta, stan::math::exp(eta));
            ...
            if (as_bool(has_weights)) {
                ...
                lp_accum__.add(dot_product(weights, pw_pois(y, eta, 1, pstream__)));
            } else {
                current_statement_begin__ = 336;
                lp_accum__.add(poisson_log<propto__>(y, eta));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sstap_count_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_sstap_count_namespace::model_sstap_count stan_model;
#ifndef USING_R
