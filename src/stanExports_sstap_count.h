...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(224, 22, "include", "data/glmer_stuff.stan");
    reader.add_event(224, 0, "start", "data/glmer_stuff.stan");
    reader.add_event(239, 15, "end", "data/glmer_stuff.stan");
    reader.add_event(239, 23, "restart", "model_sstap_count");
    reader.add_event(239, 23, "include", "data/glmer_stuff2.stan");
    reader.add_event(239, 0, "start", "data/glmer_stuff2.stan");
    reader.add_event(244, 5, "end", "data/glmer_stuff2.stan");
    reader.add_event(244, 24, "restart", "model_sstap_count");
    reader.add_event(247, 27, "include", "tdata/tdata_glmer.stan");
    reader.add_event(247, 0, "start", "tdata/tdata_glmer.stan");
    reader.add_event(262, 15, "end", "tdata/tdata_glmer.stan");
    reader.add_event(262, 28, "restart", "model_sstap_count");
    reader.add_event(266, 32, "include", "parameters/parameters_glmer.stan");
    reader.add_event(266, 0, "start", "parameters/parameters_glmer.stan");
    reader.add_event(271, 5, "end", "parameters/parameters_glmer.stan");
    reader.add_event(271, 33, "restart", "model_sstap_count");
    reader.add_event(278, 40, "include", "tparameters/tparameters_glmer_noaux.stan");
