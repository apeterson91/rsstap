...
test_that("create_S works", {
  ...
  expect_equal(c(10,20),dim(create_S(ref_one,0,0)))
  expect_equal(c(10,20),dim(create_S(ref_two,0,0)))
  expect_equal(c(25,100),dim(create_S(ref_three,0,0)))
  ## between_within decompositions
  expect_equal(list(c(10,20),c(10,20)),lapply(create_S(ref_one,1,0),dim))
  expect_equal(list(c(10,20),c(10,20)),lapply(create_S(ref_two,1,0),dim))
  expect_equal(list(c(25,100),c(25,100)),lapply(create_S(ref_three,1,0),dim))
  ## Interactions
