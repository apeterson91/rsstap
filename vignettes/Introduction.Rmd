...
```
  ...
  We'll finish our simulation of the data by including a 0-1 sex covariate to make things a little more realistic - the code containing all the simulation details can be found [here](https://github.com/apeterson91/bbnet).
